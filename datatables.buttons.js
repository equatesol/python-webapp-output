...
(function(f) {
    ...
    }) : "object" === typeof exports ? module.exports = function(g, l, z, t) {
        g || (g = window);
            ...
            if (f.isPlainObject(c)) b = a.folder(b), E(b, c);
                ...
                if (y) {
                    ...
                    for (e = d.attributes.length - 1; 0 <= e; e--) {
                        ...
                        var k = d.attributes[e].nodeValue; - 1 !== n.indexOf(":") && (h.push({
                            name: n,
                            value: k
                        }), d.removeAttribute(n))
                    }
                    e = 0;
                    for (n = h.length; e < n; e++) k = c.createAttribute(h[e].name.replace(":",
    ...
    function r(a, b, d) {
        ...
        d && (d.attr && f(c).attr(d.attr), d.children && f.each(d.children, function(a, b) {
            ...
            w && c.appendChild(a.createTextNode(d.text)));
        return c
    }
                ...
                k = function(k, q, p) {
                    ...
                    if (d) {
                        ...
                        if ((f || g && c) && a.FileReader) {
                            ...
                            b.readAsDataURL(k);
                            m.readyState = m.INIT
                        } else u || (u = (a.URL || a.webkitURL || a).createObjectURL(k)), g ? a.location.href = u : a.open(u, "_blank") || (a.location.href =
                            u), m.readyState = m.DONE, D(), h(u)
                    })()
                },
                p = k.prototype;
            if ("undefined" !== typeof navigator && navigator.msSaveOrOpenBlob) return function(a, c, b) {
                c = c || a.name || "download";
                b || (a = n(a));
    ...
    var G = function(a) {
        ...
        I = function(a, b) {
            ...
            b =
                b.footer && a.footer ? d + n(a.footer) : "";
    ...
    v.ext.buttons.copyHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            k =
                f("<span>" + b.i18n("buttons.copyKeys", "Press <i>ctrl</i> or <i>⌘</i> + <i>C</i> to copy the table data<br>to your system clipboard.<br><br>To cancel, click this message or press escape.") + "</span>").append(d);
            ...
            f(l).on("keydown.buttons-copy", function(a) {
                27 ===
    ...
    v.ext.buttons.excelHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            var k = b.buttons.exportData(c.exportOptions),
                p, v, q = function(a) {
                    ...
                    for (var b = 0, d = a.length; b < d; b++) {
                        ...
                        g || ("number" === typeof a[b] || a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/) ?
                            g = r(h, "c", {
                                attr: {
                                    t: "n",
                                    r: k
                            ...
                            }) : (m = m.replace ? m.replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "") : m, g = r(h, "c", {
                                attr: {
                                    t: "inlineStr",
                                    r: k
                                },
            ...
            x = 0;
            for (y = k.header.length; x < y; x++) q.appendChild(r(h,
                "col", {
                    attr: {
                        min: x + 1,
                        max: x + 1,
    ...
    v.ext.buttons.pdfHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            var l = [];
            c.header && l.push(f.map(d.header, function(a) {
                return {
                    text: "string" === typeof a ? a : a + "",
                    style: "tableHeader"
                }
            }));
            for (var e = 0, h = d.body.length; e < h; e++) l.push(f.map(d.body[e], function(a) {
                if (null === a || a === w) a = "";
                return {
                    text: "string" === typeof a ? a : a + "",
            ...
            c.footer && d.footer && l.push(f.map(d.footer,
                function(a) {
                    return {
                        text: "string" === typeof a ? a : a + "",
                        style: "tableFooter"
